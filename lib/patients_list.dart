...
import 'package:medicaphone_flutter/create_patient_form.dart';
...
class PatientsList extends StatelessWidget {
  final List<Map<String, String>> secretaireList = [
    {
      'name': 'Babacar Wade',
      'email': 'Date de naissance 08/04/1980',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Patients', style: TextStyle(color: Colors.black)),
            ...
            builder:
                (context) => Padding(
                  ...
                  child: Container(
                    ...
                    child: IconButton(
                      icon: Icon(Icons.search, color: Color(0xFF00A6C7)),
                      onPressed: () {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CreatePatientForm(),
                      ),
                    );
                  },
